...
export default function LoginPage() {
  ...
  return (
    <div className="text-white selection:bg-brand-orange selection:text-white min-h-screen flex flex-col items-center justify-center relative bg-brand-black w-full">
      {/* Ambient Background Glow */}
      <div className="fixed inset-0 radial-glow pointer-events-none z-0"></div>

      {/* TopNavBar */}
      <header className="fixed top-0 w-full z-50 flex justify-center items-center py-8 px-12 bg-transparent backdrop-blur-3xl">
      ...
      <main className="z-10 w-full px-6 flex flex-col items-center justify-center pt-24 pb-12">
        {/* Login Container */}
        <div className="glass-card w-full max-w-md rounded-2xl p-10 flex flex-col items-center shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 text-sm font-body max-w-[280px] mx-auto leading-relaxed">
              Continue your journey into the neural network.
            </p>
          </div>
          ...
          <form className="w-full space-y-6" onSubmit={onSubmit}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-4">
                ...
                <a
                  className="text-[10px] font-semibold uppercase tracking-widest text-brand-orange hover:text-orange-400 transition-colors"
                  href="#"
                >
                  Forgot?
                </a>
            ...
            {/* Primary CTA */}
            <button
              className="w-full btn-gradient py-4 rounded-full text-white font-display font-bold text-base tracking-tight hover:scale-[1.02] active:scale-95 transition-all duration-300 mt-4 disabled:opacity-50 flex items-center justify-center gap-2"
              type="submit"
              disabled={loading}
            >
              {loading ? (
      ...
      {/* Footer */}
      <footer className="fixed bottom-0 w-full flex justify-between items-center px-12 py-6 bg-transparent">
